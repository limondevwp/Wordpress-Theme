...
class LwhhSocialIcons_Widget extends WP_Widget {
            ...
            <div class="social-link">
                ...
                foreach ( $social_icons as $sci ) {
                    ...
                    if ( ! empty( $url ) ) {
                        ...
                        $sci = esc_attr( $sci );
                        echo "<li><a target='_blank' href='" . esc_attr( $url ) . "'><i class='fa fa-5x fa-" . esc_attr( $sci ) . "'></i></a></li>";
                    }
                }
                ?>
    ...
    public function form( $instance ) {
        ...
        <?php foreach ( $social_icons as $sci ) {
            ?>
            <p>
                <label for="<?php echo wp_kses_post( $this->get_field_id( $sci )) ; ?>"><?php echo esc_html( ucfirst( $sci ) . " " . __( 'URL', 'philosophy' ) ); ?>
                    : </label>
                <br/>
